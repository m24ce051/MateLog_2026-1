...
INSTALLED_APPS = [
    ...
    'lessons',
    'tracking',
    'ml_adaptive',  # MateLog-AE: Control vs Experimental groups
]
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'MateLog API',
    'DESCRIPTION': 'API documentation for MateLog - Educational platform for discrete mathematics',
    'VERSION': '2.0.0',
